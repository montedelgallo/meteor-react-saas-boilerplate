...
import PasswordRecoveryForm from '../components/PasswordLostForm';
      ...
      <div className="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
        <div className="d-flex flex-column align-content-end">
          <div className="app-auth-body mx-auto">
            ...
            <h2 className="auth-heading text-center mb-4">Recover your password</h2>
            <div className="auth-form-container text-start mx-auto">
              <PasswordRecoveryForm />
              <div className="auth-option text-center pt-5">Changed your mind? <Link to="/login">Log In</Link></div>
            </div>
          </div>
